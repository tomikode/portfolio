	...
	return (
		<div id="quicktypeContainer">
			<div className="projectText">
				...
				<p>
					QuickType was a project aimed at creating a typing test web
					application that can be used to measure the speed of one's
					typing or simply practice. Test it out here! Or click the button 
			...
			<embed className="quicktype" src="https://quicktype.vercel.app/" />
		</div>
	);
};
